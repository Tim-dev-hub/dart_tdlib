  ...
  void writeToFile() {
    ...
    for (final obj in _objects) {
      ...
      if (obj.isParent) {
        ...
        fromJsonFields.add('}');
        fromJsonFields.add("throw new Exception(\'undefined type\');");
      } else {
...
class TlObjectArg {
  ...
  static String getWrite(String argName, String type,
    ...
    if (dartTypes.contains(type)) {
      ...
      writeToJson = ' == null ? null : ${argName}?.toJson()';
    } else {
      writeToJson = '.toJson()';
    }
